...
Version 6.0.0-rc.16 makes clean startup and continuation script-driven. Claude Code selects the current-host browser deterministically, saves the verified binding, records every task transition through one runtime command, and resumes from saved evidence without optional setup loops.
