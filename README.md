...
Version 6.0.0-rc.11 makes the marketplace card, skill summaries, and routine Claude Code updates short and human-readable. Technical details remain available only when a diagnosis is requested.
