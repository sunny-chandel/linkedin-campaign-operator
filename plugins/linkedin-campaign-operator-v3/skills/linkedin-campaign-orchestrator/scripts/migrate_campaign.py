...
def main() -> int:
    ...
    if state_path.is_file():
        ...
        runtime_instructions["active_version"] = "6.0.0-rc.9"
        runtime_instructions["detected_version"] = "6.0.0-rc.9"
        runtime_instructions["session_version"] = "6.0.0-rc.9"
    ...
    if algorithm_path.exists():
        ...
        merged_algorithm["version"] = "6.0.0-rc.9"
